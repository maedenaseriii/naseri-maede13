                ...
                {title.map((item) => {
                  return (
                    <li
                      ...
                      className={`text-gray-600 cursor-pointer flex items-center justify-center gap-2 hover:bg-slate-400 w-34 p-2.5 h-8 hover:text-pink-600 rounded-xl ${
                        currentTab === item.id ? "bg-slate-300 text-gray-800" : ""
                      }`}
                    >
                      {item.name}
                    </li>
